// ==================== frontend/src/pages/host/CreateEvent.tsx (ENHANCED WITH AI) ====================
        ...
        <div className="bg-white rounded-2xl shadow-xl border-2 border-purple-200 p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Tell us about your event and AI will generate everything you need!
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-2">
                Be specific! Include: event type, target audience, key activities, and what makes it
                special.
              </p>
            </div>
              ...
              <div className="bg-purple-50 border-2 border-purple-200 rounded-lg p-6">
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    {generationStep === 'idle' ||
                      (generationStep === 'content' && <span className="w-5" />)}
  ...
  return (
    <>
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-4 sm:py-8">
        ...
        {/* Form Steps - Same as before but with validation */}
